...
bool isQuietHours() {
  ...
  if (!getLocalTime(&timeinfo)) {
    // If NTP time is not available, do not enter quiet mode by default.
    return false;
  }
...
// In this prototype ALCOHOL_CONFIRMED is used instead.
const int MQ3_THRESHOLD = 1500;
...
const int   FSR_EMPTY  = 1000;
const int   FSR_HALF   = 2400;
const int   FSR_FULL   = 2900;
